...
--
-- Apply (MySQL):
--   mysql -u llm_router -p llm_router < migrations/1.0.2/migration_mysql_1.0.2.sql

ALTER TABLE lr_provider_models ADD COLUMN description VARCHAR(255) NULL AFTER upstream_model_name;
